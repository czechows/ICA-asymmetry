\subsection{lepsze PCA}

najpierw dane normalizujemy

potem bierzemy przemnozone przez wagi

$(x_i,w_i)$ gdzie $w_i=N(m,\Sigma)(x_i)/\sum$

teraz powinno byc ze $N(m,\Sigma/2)$, a wychodzi inne, przyblizamy estymacje
za pomoca $N(m,\tilde m^T \tilde m+\tilde \Sigma)$

czyli mamy dwie gestosci, chcemy znalezc najwieksza roznice

jezeli znormalizujemy, to dostajemy 

potem estymacja po gestosci, przy zalozeniu, ze w zerze - $\Sigma+m^Tm$

KL

wybieramy tyle największych ile potrzebujemy

i rzutujemy prostopadle
...
Najpierw dane dekorelacja

potem wzor na KL

maksymalizowanie wzgledem 
$$
{\displaystyle D_{\text{KL}}({\mathcal {N}}_{0}\|{\mathcal {N}}_{1})={1 \over 2}\left(\mathrm {tr} \left(\Sigma _{1}^{-1}\Sigma _{0}\right)+\left(\mu _{1}-\mu _{0}\right)^{\top }\Sigma _{1}^{-1}(\mu _{1}-\mu _{0})-k+\ln \left({\det \Sigma _{1} \over \det \Sigma _{0}}\right)\right).} D_{\text{KL}}({\mathcal {N}}_{0}\|{\mathcal {N}}_{1})={1 \over 2}\left(\mathrm {tr} \left(\Sigma _{1}^{-1}\Sigma _{0}\right)+\left(\mu _{1}-\mu _{0}\right)^{\top }\Sigma _{1}^{-1}(\mu _{1}-\mu _{0})-k+\ln \left({\det \Sigma _{1} \over \det \Sigma _{0}}\right)\right).
$$
szukac projekcji - czy da sie znalezc jakis wzor?
